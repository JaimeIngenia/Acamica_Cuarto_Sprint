    ...
    return (
        <div>
            <div className={style.friendProfile}>
                <Link to="/feed">
                    <div className={style.titulo}>
                        ...
                        <h2 style={{ color: color }} className={style.lorem2}>USERNAME X</h2>
                    </div>
                </Link>
                {/* 
            ...
            <div className={style.profile}>
                ...
                <div style={{ background: color }} className={style.cuadro}><h2 className={style.username} >USERNAME X</h2></div>
